  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Card padding="lg" className="mt-4">
        <h1 className="text-xl font-semibold text-ink">{t("Nuevo producto")}</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-5">
          <Input
            ...
            placeholder={t("Ej: Jeans tiro alto MUMU")}
            value={name}
          ...
          <MultiFileUpload
            label={t("Imágenes del producto *")}
            value={images}
            onChange={setImages}
            max={3}
            helperText={t("Se usan como referencia en cada anuncio generado con IA.")}
          />
