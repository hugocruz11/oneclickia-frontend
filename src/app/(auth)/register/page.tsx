...
export default function RegisterPage() {
  ...
  return (
    <Card>
      <h2 className="text-xl font-semibold text-ink">{t("Crear cuenta")}</h2>
      <p className="mt-2 text-sm text-muted">
        {t("Empieza a generar campañas con IA en minutos.")}
      </p>

      <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
        <Input
          label={t("Nombre (opcional)")}
          type="text"
        ...
        <PasswordInput
          ...
          helperText={t("Mínimo 8 caracteres.")}
        />
        <PasswordInput
